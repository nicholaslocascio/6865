...
void testAutoStitchBlendCustom() { // custom
  Image custom1("./Input/custom-1.png");
  Image custom2("./Input/custom-2.png");
  autostitch(custom1, custom2, 1).write("./Output/custom-autostitch-linearblending.png");
  autostitch(custom1, custom2, 2).write("./Output/custom-autostitch-2scaleblending.png");
}
...
void testAutoStitchNCustom() {
  vector<Image> ims;
  ims.push_back(Image("./Input/custom-1.png"));
  ims.push_back(Image("./Input/custom-2.png"));
  ims.push_back(Image("./Input/custom-3.png"));
  autostitchN(ims, 1).write("./Output/custom-autostitchN.png");
}
