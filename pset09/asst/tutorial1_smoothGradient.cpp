...
// which means that it is a language within a language, in our case within C++.
// Creating a Halide program involves creating C++ objects that represent the Halide program,
// then calling the Halide compiler from C++ to turn these objects into executable binaries.
...
int main(int argc, char** argv)
{
    ...
    save(output, "Output/tut1_result.png");
